...
public class locatorCreateProducto {
	...
	public static final By LOCATOR_PROFILE = By.xpath("//*[@id=\"cdk-overlay-0\"]/nb-context-menu/nb-menu/ul/li[1]/a/span");
	...
	public static final By LOCATOR_PRICE = By.id("price");
